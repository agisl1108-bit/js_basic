...
// let num = Number(prompt('구입 수향을 입력하세요.'));
let num = Number('1');
let plus = ++num;
...
wallet += month;
let total = (`용돈을 더해서 총 ${wallet}원이 있습니다.`)
console.log(total);

//지갑 10000 준비
// 편의점에서 물건을 구입할때 지갑의 돈이 나가는 상황
// 삼각김밥 2000, 아이스크림 3000, 과자 4000, 남은 돈
// 결과형태) 편의점 총 구입비는 oooo원이고 남은 돈은 oooo원입니다.

wallet = 10000
let kimbad = 2000;
let iceCream = 3000;
let snack = 4000;
total = kimbad + iceCream + snack;
wallet -= kimbad;
