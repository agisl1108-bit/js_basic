...
// typeResult 변수 생성
// BOOlean내장함수 활용 data1 변수애 들어간 논리데이터종류확인
// typeResult 대입
...
data2 = '가나다라';
data3 = data2 * 10; //NsN (Not a Number)
console.log(data3);
typeResult = Boolean(data3);
console.log(`data3의 데이터타입은 : ${typeResult}`); // 출력
...
// 조건문
// if(조건식){조선식이 참일때 실행되는 실행문}
// if(조건식){조선식이 참일때}else{조건식이 거짓일때 실행}
...
adBtn.addEventListener('click', function(){
    let user1 = confirm('당신은 성인이십니까?');
    console.log(user1);
    if(user1) location.href = 'https://google.com';
